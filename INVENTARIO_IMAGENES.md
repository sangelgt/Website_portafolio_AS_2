...
| :--- | :--- | :--- | :--- |
| `app/modules/header.module/module.html` | HubSpot Module Variable: `module.logo.src` | Logo principal en el encabezado | N/A, Dinámico, No lazy-loading |
| `app/modules/footer.module/module.html` | HubSpot Module Variable: `module.logo.src` | Logo en el pie de página | N/A, Dinámico, No lazy-loading |
...
| Componente/Contenedor | Ruta de Subida/Reemplazo | Metadato Descriptivo (Propósito) | Especificaciones (Dimensión/Tipo) |
| :--- | :--- | :--- | :--- |
| `app/templates/index.html` | https://grainy-gradients.vercel.app/noise.svg | Decorative grid inside card | N/A, CDN, No lazy-loading |
| `app/templates/index.html` | https://lh3.googleusercontent.com/aida-public/AB6AXuDm8eRCPqD295DY3uYYUHxAIZV94lW5W-H9rcCvV4HP6sBTQDQ_e6tVdg4jLQr2KJdH2o9ohkLLzr7tl6m258RxBiP8Tf9qMrGy8To3RBeJsP0chGgLsp3uziXXTflkFI1XGv2gFxzDqEKHniMmRCDPAN0IlxF3ObXVddoVujZ4uU60akkA3pnEOImiv4cjYS-nAmxJ8J_uF5gByOI8WtLOaOqRUtHFJqJ1dCOr4INqdYTKe7fG0SLa6eIVHMvMUeEAV8bLm8Vr0d3B | Abstract geometric dark data visualization showing network nodes and connections | N/A, CDN, No lazy-loading |
| `app/templates/index.html` | https://lh3.googleusercontent.com/aida-public/AB6AXuDLVqptgh541FXkkm-3-f4RVx0ZRGIlKFtaSWqs4aKuKoyIsrcpHsnhnPRNCnENDB5c23HlHun_RiTS49-FYIQTvHWTqix8Onys8BThLzgpWiOGjibJOdmFQP02NYWqLFAMtn7qFi_m5FoyI9WdPvPWxGwfVvEM5rQ9J4bhEFmUI5ni3etsKFMBOoXT3oz4NzPqaBchTGxsQUjQmw5VmKBFNCHEtjaIEU_EtigSEFBNeGyGXFQMdD--XYbrCpJWzrWwpG0lH1fry1MN | Close up of black server rack hardware with purple led lights indicating status | N/A, CDN, No lazy-loading |

## Página: Diagnostics

| Componente/Contenedor | Ruta de Subida/Reemplazo | Metadato Descriptivo (Propósito) | Especificaciones (Dimensión/Tipo) |
| :--- | :--- | :--- | :--- |
| `app/templates/diagnostics.html` | https://lh3.googleusercontent.com/aida-public/AB6AXuCsHmhqtcFVWWA9N8aOeeQ_ID69hy2EWyPMbTPmmg4uX6-dYx0dTgE-460TI69jLszsJ18OvyiSWED6I9uWqqeL_gnP44LFRyLCPT72gVAtmG51IlayT7un1arUa9CabfJk1dEWWoMlQSNdoS5Rr6P9A-ffnbRnX-bcEG7QeNERr2zs2-RSwnXe1r62rUG6QntUrHADlCe2tSUX7lDAnLzajifOnWHl103684ZhXc-a2i-vI-jJmt3ccoGa8M-Pa1K2_2n5qAdZ6bSm | Abstract digital data pattern representing server node connections | N/A, CDN, No lazy-loading |
